namespace UglyToad.PdfPig.Graphics.Colors
{
    ...
    /// <see cref="IIccProfile"/> handle. Implementations should cache
    /// parsed profiles (recommended key: profile content hash plus
    /// component count) so the same profile is parsed at most once.
    /// </summary>
    /// <remarks>
    ...
    /// <para>
    /// Per-intent transforms are obtained from the returned
    /// <see cref="IIccProfile"/> via
    /// <see cref="IIccProfile.TryGetTransform(Graphics.Core.RenderingIntent, out IIccTransform)"/>.
