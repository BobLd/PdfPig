                ...
                case ColorSpace.ICCBased:
                    {
                        ...
                        var iccProfile = streamToken.Decode(filterProvider, scanner);

                        return new ICCBasedColorSpaceDetails(numeric.Int, alternateColorSpaceDetails, range, metadata, iccProfile);
                    }
