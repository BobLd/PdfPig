                ...
                case ColorSpace.ICCBased:
                    {
                        ...
                        var profile = streamToken.Decode(filterProvider, scanner);
                        return new ICCBasedColorSpaceDetails(numeric.Int, alternateColorSpaceDetails, range, metadata, profile);
                    }
