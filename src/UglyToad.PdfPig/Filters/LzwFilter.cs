...
namespace UglyToad.PdfPig.Filters
{
    ...
    public sealed class LzwFilter : IFilter
    {
        ...
        private static byte[] Decode(ReadOnlySpan<byte> input, bool isEarlyChange, int predictor, int colors, int bitsPerComponent, int columns)
        {
