namespace UglyToad.PdfPig.Parser.FileStructure
{
    ...
    {
        public static LinearisationParameter? Parse(IInputBytes inputBytes,
            ...
            ParsingOptions parsingOptions)
        {
            ...
            int byteRead = inputBytes.Read(header);
            ...
            var scanner = new PdfTokenScanner(inputBytes, locationProvider, filterProvider, NoOpEncryptionHandler.Instance, parsingOptions);
