namespace UglyToad.PdfPig.Tests.Util
{
    ...
    public class StackDictionaryTests
    {
        ...
        {
            // Levels are pushed straight from a cache and may be pushed again later, so a write has to
            // copy the level first rather than reach into the cached dictionary. See issue #1390.
